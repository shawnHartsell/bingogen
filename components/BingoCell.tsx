      ...
      className={`
        ...
        ${
          cell.isCompleted
            ...
            : "border-zinc-300 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200/80 dark:hover:bg-zinc-800/80"
        }
    ...
    >
      ...
      {isEditing ? (
        <input
          ...
          className="w-full bg-zinc-200 dark:bg-zinc-800 border border-yellow-500/50 rounded px-1 py-0.5
