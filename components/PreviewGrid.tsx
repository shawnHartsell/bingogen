        ...
        <div
          ...
          className={`
            ...
            ${cell.isFreeSpace
              ...
              : cell.isEmpty
                ? "border-zinc-200 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/30 border-dashed"
                : "border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 group"
            }
          `}
        >
          ...
          {!cell.isFreeSpace && !cell.isEmpty && (
            <button
              ...
              className="absolute top-0.5 right-0.5 w-4 h-4 sm:w-5 sm:h-5 rounded-full flex items-center justify-center
                text-zinc-600 hover:text-red-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors
          ...
          <span
            className={`
              ...
              ${cell.isEmpty ? "text-zinc-700 text-[9px] sm:text-[10px]" : "text-zinc-700 dark:text-zinc-300"}
            `}
          >
            {cell.isFreeSpace
              ? "FREE"
